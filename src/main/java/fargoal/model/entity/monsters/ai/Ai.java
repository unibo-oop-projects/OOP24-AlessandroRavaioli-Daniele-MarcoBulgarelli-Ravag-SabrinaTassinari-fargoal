...
public class Ai {
    ...
    public static void move(AbstractMonster monster, Player player) {
        ...
        if(!check) {
            ...
            do {
                ...
                cont++;
            } while (monster.getFloorMap().isTile(pos) || cont == 15);
            if(cont != 15) {
                monster.setPosition(pos);
            }
        } 
    ...
    public static void moveSpider(Spider spider, Player player) {
        ...
        if(xDistance < MAX_DISTANCE && yDistance < MAX_DISTANCE) {
            ...
            do {
                pos = spider.getPosition().add(new Position(spider.getRandom(POSSIBLE_DIRECTIONS), spider.getRandom(POSSIBLE_DIRECTIONS)));
