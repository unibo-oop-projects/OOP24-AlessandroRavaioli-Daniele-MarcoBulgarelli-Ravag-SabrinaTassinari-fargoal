...
\paragraph{Soluzione} Ogni tipo di item ha delle caratteristiche simili, è stato quindi utilizzato il \textit{pattern Template Method}, in modo da poter riutilizzare la stessa classe per sviluppare più item.
%
Per quanto riguarda gli incantesimi, il metodo template è 
